...
const MAX_WIDTH: u32 = 0x40;
const MAX_HEIGHT: u32 = 0x20;
...
pub fn main() !void {
    const screenWidth = MAX_WIDTH * PIXEL_SIZE;
    const screenHeight = MAX_HEIGHT * PIXEL_SIZE;
...
fn drawPixelOnScreen(x: i32, y: i32, isActive: bool) void {
    ...
    rl.drawRectangle(x, y, PIXEL_SIZE, PIXEL_SIZE, color);
}
